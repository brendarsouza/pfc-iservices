...
<html>
    <head>
        ...
        <title>ISERVICES - Erro Data Pedido</title>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-6">
                             <center>
                            <h3 style="color:red;">ERRO! O dia escolhido para receber o serviço está no passado.<br/> Por favor refaça a operação.</h3>
                            <form action="../areaCliente" method="post" > 
