                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-6">
                             <center>
                            <h3 style="color:red;">Houve um erro durante a realização do pedido. <br/> Confira a mensagem de erro: O horário desejado para iniciar o serviço está posterior ao horário de atendimento do profissional!</h3>
                            <form action="../areaCliente" method="post" > 
