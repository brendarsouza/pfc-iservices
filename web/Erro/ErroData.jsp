                            ...
                            <div class="col-sm-12">
                                <a href="../cadastro.jsp">
                                    <div class="container">
                                        ...
                                        <div class="middle">
                                            <div class="text"><h1 style="color: black;">Erro a data informada é inválida! <br/><a href="../cadastro.jsp" style="color: red">Clique aqui e tente novamente!</a></h1></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
