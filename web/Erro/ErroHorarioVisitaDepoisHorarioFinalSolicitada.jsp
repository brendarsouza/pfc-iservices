...
<html>
    <head>
        ...
        <title>ISERVICES - Erro Horário Visita</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Erro no horário da Visita!
                    </h1>
                    
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Erro Horário Visita</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-6">
                            ...
                            <h3 style="color:red;">Houve um erro durante a realização da visita. <br/> Confira a mensagem de erro: 
                                O horário da Visita está depois do Horário Final disponível, solicitado pelo cliente.
                            </h3>
                                 <center><form action="../areaProfissional" method="post"> 
