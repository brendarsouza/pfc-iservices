<%-- 
    Document   : ErroHorarioVisitaAntesHorarioInicialSolicitada
    Created on : 01/12/2017, 15:18:16
    Author     : brenda
--%>
...
<html>
    <head>
        ...
        <title>ISERVICES - Erro Data Orçamento</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Erro na data do orçamento!
                    </h1>
                    
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Erro Data Orçamento</li>
                    </ol>
                </section>
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-6">
                             <center>
                            <h3 style="color:red;">Houve um erro durante a realização do orçamento. <br/> Confira a mensagem de erro: 
                                A data prevista para iniciar o serviço está antes da data desejada para receber o serviço, conforme solicitado no Pedido!
                            </h3>
                                 <center><form action="../areaProfissional" method="post"> 
