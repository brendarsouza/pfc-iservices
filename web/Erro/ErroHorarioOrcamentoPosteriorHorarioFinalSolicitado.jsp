...
<html>
    <head>
        ...
        <title>ISERVICES - Erro Horário Orçamento</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Erro na horário do Orçamento!
                    </h1>
                    
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Erro Horário Orçamento</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xs-6">
                            ...
                            <h3 style="color:red;">Houve um erro durante a realização do orçamento. <br/> Confira a mensagem de erro: 
                                Horário Visita está após do horário disponivel solicitado, conforme o Pedido.
                            </h3>
                                 <center><form action="../areaProfissional" method="post"> 
