...
<html>
    <head>
        ...
        <title>ISERVICES - Requisitar Login Cliente</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('../imagens/353938376.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    
                    <ol class="breadcrumb" style="color:white;">
                        <li><a style="color: black;"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active" style="color: black;">Login Cliente</li>
                    </ol>
<!--                </section>
                <section class="content">-->
                    <form action="../ControleAcessoCliente" method="post">
                        <div class="container">
                            <center><h1>
                            Antes de solicitar um serviço, faça seu login!
                        </h1>
                                <small><b>Cliente faça aqui seu login.</b></small></center>
                            ...
                            <div class="card card-container">
                                ...
                                <p style="text-align: right;"><a href="../cadastro.jsp" style="text-align: right;" class="forgot-password"> 
                                    Cadastre-se
                                    </a></p>
                            </div><!-- /card-container -->
                        </div>
