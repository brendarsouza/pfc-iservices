            ...
            <div class="container-fluid">
                <div class="bg-1">
                    ...
                    <center><h3>Seu login esta inativo, deseja ativá-lo? </h3>    
                        <br>
                        <a href="./LoginCliente/AtivarLogin.jsp"><img src="imagens/icone.png" alt="Sandwich" style="width:80%; opacity: 0.4"></a>
                        <br><br>
                        <h4 ><a href="./LoginCliente/AtivarLogin.jsp" style="color: red">Clique aqui para ativar seu login.</a></h4>
                        <br> 
                    </center>                
                </div> 
