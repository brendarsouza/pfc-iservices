...
<html>
    <head>
        ...
        <title>ISERVICES - Ativar Login Cliente</title>
...
<link rel="stylesheet" href="./css/LoginLogout.css">
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('./imagens/345349079.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    
                    <ol class="breadcrumb" style="color:white;">
                        <li><a style="color: white;"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active" style="color: white;">Login Cliente</li>
                    </ol>
<!--                </section>
                <section class="content">-->
                    <form action="./ControleAcessoCliente" method="post">
                        <div class="container">
                            ...
                            Ativação de Login Cliente
                        </h1>
                        <small style="color: black;">Cliente ative seu login aqui.</small></center>
                            ...
                            <div class="card card-container">
                                ...
                                <input type="password" id="inputPassword" class="form-control" minlength="6" maxlength="18" name="txtSenha" placeholder="Senha" required>
                                <br/>
                                <input type="submit" class="btn btn-lg btn-primary btn-block btn-signin" value="Ativar" name="acao"/>                               
                                ...
                                <br/>
                                <a href="./LoginProfissional/LoginProfissional.jsp" style="text-align: right;" class="forgot-password"> 
                                    Profissional, faça seu login aqui.
                                </a>
                            </div><!-- /card-container -->
                        </div>
                    </form>
