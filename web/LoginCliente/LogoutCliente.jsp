...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação de Envio de Pedido</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('../imagens/sairCliente.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">

                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Logout Cliente</li>
                    </ol>
                </section>
                    ...
                    <form action="../ControleAcessoCliente" method="post">
                        <div class="container">
                            ...
                            <div class="card card-container">
                                ...
                                <input type="email" id="inputEmail" class="form-control" disabled name="txtEmail" value="<%=cliente.getUsuario().getEmail()%>" required autofocus>
