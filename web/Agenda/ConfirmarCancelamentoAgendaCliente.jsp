...
<html>
    <head>
        ...
        <title>ISERVICES - Cancelar Agendamento</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Cancelar Agendamento</li>
                    </ol>
                </section>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-footer">
                                        <h3 class="widget-user-username"><%=agenda.getOrcamento().getPedido().getProfissional().getNome()%> <%=agenda.getOrcamento().getPedido().getProfissional().getSobrenome()%></h3>
                                        <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%=agenda.getOrcamento().getPedido().getProfissional().getCidadeAtendimento() %> - <%=agenda.getOrcamento().getPedido().getProfissional().getEstadoAtendimento()%></small></p> 
