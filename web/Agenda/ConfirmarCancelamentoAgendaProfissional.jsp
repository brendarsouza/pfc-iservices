...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Agendamentos Em Espera Profissional</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Listar Agendamentos Em Espera
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Agendamentos Em Espera</li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content container-fluid">
                    <form action="./cancelarAgendamentoProfissional" method="post" > 
                        ...
                        <div class="row pull-center">
                            <h1 style="text-align: center;">Você deseja cancelar o agendamento?</h1><br/>
                            <div class="col-md-6">
                                <!-- Widget: user widget style 1 -->
                                <div class="box box-widget">
                                    <!-- Add the bg color to the header using any of the bg-* classes -->
                                    <div class="widget-user-header bg-aqua-active" style="padding: 5px 5px 5px 5px">
                                        <h3 style="text-align: center;">Dados do Agendamento</h3>
                                    </div>
                                    <div class="box-footer">
                                        ...
                                        <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getRua()%>,<%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getNumero()%> - <%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getBairro()%>, <%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getCidade()%> - <%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getEstado()%> - <%=agenda.getOrcamento().getPedido().getCliente().getEndereco().getPais()%></small></p> 
                                        <h5 class="widget-user-desc"><b>Data do Pedido: </b><%=agenda.getOrcamento().getPedido().getDataPedido()%></h5>
                                        <h5 class="widget-user-desc"><b>Descrição do Problema: </b>"<i><%=agenda.getOrcamento().getPedido().getDescricaoProblema()%></i>"</h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-footer">
                                        <h4>Você deseja cancelar o Agendamento por qual motivo?</h4>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="input-group date">
                                                                ...
                                                                <input type="date" class="form-control pull-right" id="dataVisita" name="txtDataAgendamento">
                                                            </div>
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="time" class="ss-q-time form-control pull-left" dir="auto" id="horarioVisita" name="txtHoraAgendamento">
                                                            </div>
                                                        </div>
                                                    </div>
