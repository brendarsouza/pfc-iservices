...
<html>
    <head>
        ...
        <title>ISERVICES - Cancelar Agendamento Profissional</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form action="./recusarAgendamentoProfissional" method="post" > 
                        <div class="container">
                            <br>
                            <!-- id do u-->
                            ...
                            <h1>Você deseja cancelar o novo Agendamento?</h1><br/>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-widget">
                                        ...
                                        <div class="box-footer">
                                            <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i>
                                                <b>Data do Agendamento: </b><%=agenda.getDataAgendamento()%>
                                                às
                                                <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i>
                                                <%=agenda.getHoraAgendamento()%></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input  type="submit" class="btn btn-warning center-block"  value="Confirmar">                        
                                </div>
                                <div class="col-sm-5">
                                </div>
                            </div>
