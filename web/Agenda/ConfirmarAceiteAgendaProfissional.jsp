...
<html>
    <head>
        ...
        <title>ISERVICES - Cancelar Agendamento Cliente</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Aceitar Agendamento</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <form action="./aceitarAgendamento" method="post" > 
                        <div class="container">
                            <br>
                            <!-- id do u-->
                            ...
                            <h1>Você deseja aceitar o novo Agendamento?</h1><br/>
                            <div class="row">
                                <div class="col-md-12">
