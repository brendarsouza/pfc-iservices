...
<html>
    <head>
        ...
        <title>ISERVICES - Nova Agendamento Recusado Profissional</title>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../consultarPedidosProfissional">Todos Pedidos </a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../buscarAvaliacoesProfissional">Todas Avaliações </a></li>
                                <li><a href="../consultarNaoAvaliados">Avaliações Pendentes </a></li>
                                <li><a href="../buscarPedidosAvaliadosProfissional">Pedidos Avaliados </a></li>
