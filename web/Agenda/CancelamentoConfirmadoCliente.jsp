<%-- 
    Document   : CancelamentoConfirmado
    Created on : 18/09/2017, 17:21:56
    Author     : brenda
--%>
...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação Reagendamento</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        O Pedido foi reagendado com sucesso!
                    </h1>
                    <small>Confira em "Pedidos Reagendados" o pedido reagendado.</small>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Confirmação de Reagendamento</li>
                    </ol>
                </section>
