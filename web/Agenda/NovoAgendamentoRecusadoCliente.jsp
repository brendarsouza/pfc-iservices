...
<html>
    <head>
        ...
        <title>ISERVICES - Nova Agendamento Recusado Cliente</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <small>Se você cancelou uma nova data para realizar o serviço, confira em "Agendamentos Cancelados" o pedido cancelado.</small>
                    
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Novo do Agendamento</li>
                    </ol>
                </section>
                            ...
                            <div class="small-box bg-red">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="../consultarAgendaCliente">Todas Agendamentos<span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        ...
                                        <li><a href="../consultarAgendaCanceladaCliente">Agendamentos Cancelados <span class="pull-right badge bg-red"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li></li>
                                    </ul>
                                </div>
                            </div>
