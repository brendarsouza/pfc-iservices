...
<html>
    <head>
        ...
        <title>ISERVICES - Acesso Negado</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1 style="font-size: 34pt; color: red;">
                        Erro, você não tem a permissão de acesso!
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <center>
                            <div class="col-sm-12">
                                <a href="../index.jsp">
                                    <div class="container">
                                        <img src="../imagens/icone.png" class="image" alt="Acesso negado" width="100%" height="auto">
                                        <div class="middle">
                                            <div class="text"><h1 style="color: black;">Acesso negado!<br/><a href="index.jsp" style="color: black">Clique aqui e tente novamente!</a></h1></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
