...
<html>
    <head>
        ...
        <title>ISERVICES - Aprovar Visita Profissional</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                   <form action="./aceitarVisitaProfissional" method="post" > 
                       <input type="text" hidden name="txtIdVisita" value="<%=visita.getId()%>">
                        ...
                        <div class="row pull-center">
                            <h1 style="text-align: center;">Você deseja aceitar a Visita?</h1><br/>
                            <div class="col-md-12">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-body">
                                        <h3 class="widget-user-username"><%=visita.getPedido().getCliente().getNome()%> <%=visita.getPedido().getCliente().getSobrenome()%></h3>
                                        <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%=visita.getPedido().getCliente().getEndereco().getRua()%>,<%=visita.getPedido().getCliente().getEndereco().getNumero()%> - <%=visita.getPedido().getCliente().getEndereco().getBairro()%>, <%=visita.getPedido().getCliente().getEndereco().getCidade()%> - <%=visita.getPedido().getCliente().getEndereco().getEstado()%> - <%=visita.getPedido().getCliente().getEndereco().getPais()%></small></p> 
                                        <h5 class="widget-user-desc"><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></h5>
                                        <h5 class="widget-user-desc"><b>Descrição do Problema: </b>"<i><%=visita.getPedido().getDescricaoProblema()%></i>"</h5>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Dia em que o cliente está disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data disponível: </b></a><%=visita.getPedido().getDataDesejada()%></h5>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Horário em que o cliente está disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Horário disponível: </b></a><%=visita.getPedido().getHorarioInicialDisponivel()%> às <%=visita.getPedido().getHorarioFinalDisponivel()%></h5>
                                        <hr>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Dia em que o cliente receberá a visita!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Visita: </b></a><%=visita.getDataVisita()%></h5>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Horário em que o cliente receberá a visita!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Horário da Visita: </b></a><%=visita.getHoraVisita()%></h5>
                                        
                                    </div>
                                        <div class="box-footer">
                                            <input  type="submit" class="btn btn-warning center-block"  value="Aceitar"> 
                                        </div>
                                </div>
                            </div>
