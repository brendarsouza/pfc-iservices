        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <small>Se você somente cancelou a visita confira em "Visitas Canceladas" a visita cancelada.</small>
                    <small>Se você cancelou a visita e a reagendou confira em "Visitas Remarcadas" o andamento da visita.</small>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Cancelamento da Visita</li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <p>Visitas Remarcadas e Visitas Canceladas</p>
                                </div>
                                <div class="icon">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        ...
                                        <li><a href="../consultarVisitasRemarcadasProfissional">Visitas Remarcadas <span class="pull-right badge bg-aqua"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a href="../consultarVisitasCanceladasProfissional">Visitas Canceladas <span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
