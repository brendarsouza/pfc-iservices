...
<html>
    <head>
        ...
        <title>ISERVICES - Cancelar Visita Profissional</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form action="./cancelarVisitaProfissional" method="post" > 
                        <input type="text" hidden name="txtIdUsuario" value="<%=profissional.getUsuario().getId()%>">
                        ...
                        <div class="row pull-center">
                            <h1 style="text-align: center;">Você deseja cancelar a Visita?</h1><br/>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-footer">
                                        <h4>Você deseja cancelar a Visita por qual motivo?</h4>
                                                ...
                                                <div id="collapse1" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            ...
                                                            <h3 class="widget-user-username">Horário Visita:</h3>
