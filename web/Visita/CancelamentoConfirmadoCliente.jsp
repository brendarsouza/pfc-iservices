...
<html>
    <head>
        ...
        <title>ISERVICES - Cancelamento Visita</title>
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="../consultarVisitasCanceladasCliente">Visitas Canceladas <span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
