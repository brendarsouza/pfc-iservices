...
<html>
    <head>
        ...
        <title>ISERVICES - Visita Agendada</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Visita Agendada</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <p>Confira em "Visitas Em Espera", a visita agenda.</p>
                    <!--<h3 style="color: black">A visita foi agendada com sucesso! <br/>Clique no botão abaixo para conferir as visitas agendadas!</h3>-->
                    <div class="row">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        ...
                                        <li><a href="../consultarVisitasEmEsperaProfissional">Visitas Em Espera <span class="pull-right badge bg-aqua"><i class="fa fa-arrow-circle-right"></i></span></a></li>
