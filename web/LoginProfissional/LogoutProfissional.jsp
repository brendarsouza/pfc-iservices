...
<html>
    <head>
        ...
        <title>ISERVICES - Logout Cliente</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <center><form action="../areaProfissional" method="post"> 
                            <input type="text" name="txtIdProfissional" value="<%=profissional.getId()%>" hidden>
                            <button type="submit" name="AreaProfissional" class="btn btn-md btn-warning" style="width: 100%;"><i class="fa fa-home fa-lg"></i></button>
                        </form></center>
            ...
            <div class="content-wrapper" style="background-image:url('../imagens/447406066.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">

                    <ol class="breadcrumb">
                        <li><a style="color: black;"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active" style="color: black;">Logout Profissional</li>
                    </ol>
                </section>
                <section class="content">
                    <form action="../ControleAcessoProfissional" method="post">
                        <div class="container">
                            ...
                            <input type="text" name="txtIdUsuario" hidden value="<%=usuario.getId()%>">
                            <div class="card card-container">
                                ...
                                <input type="email" id="inputEmail" class="form-control" disabled name="txtEmail" value="<%=profissional.getUsuario().getEmail()%>" required autofocus>

                                
                                <br/>
                                <input type="submit" class="btn btn-lg btn-primary btn-block btn-signin" value="Sair" name="acao"/>                               
