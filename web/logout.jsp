    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                 <!--style="background-image:url('imagens/fundo_4.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">-->
                    ...
                    <div class="row">
                        <center>
                            <div class="col-sm-12">
                                <a href="index.jsp">
                                    <div class="container">
                                        <img src="imagens/logout.png" class="image" alt="Login" width="100%" height="auto">
                                        <div class="middle">
                                            <div class="text">Clique <br/> para logar novamente.</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
