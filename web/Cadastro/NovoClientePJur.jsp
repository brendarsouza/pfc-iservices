                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="email" maxlength=10 name="txtTelefone" placeholder="1147610250" required>
                                </div>
                                <div class="col-sm-4">
                                    <label for="nome">Celular:</label>
                                    <input type="name" class="form-control" id="celular" maxlength=11 name="txtCelular" placeholder="Ex. 11999885544">
                                </div>
                            </div>
                            <div class="row">

                                <div class="col-sm-4">
                                    <label for="nome"><b style="color:red">*</b> CNPJ:</label>
                                    <input type="name" class="form-control" id="cnpj" name="txtCNPJ" maxlength=14 minlength="14" placeholder="Ex. 37713181000103" required >
                                </div> 
                                <div class="col-sm-4">
                                    <label for="nome"><b style="color:red">*</b> Razão Social:</label>
                                    <input type="name" class="form-control" id="razaoSocial" name="txtRazaoSocial" placeholder="Razão Social" required>
                                </div>
                                <div class="col-sm-4" >
                                    <br>
