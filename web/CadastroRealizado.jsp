...
<html>
    <head>
        ...
        <title>ISERVICES - Cadastro Realizado</title>
                    ...
                    <div class="row">
                        <center>
                            <div class="col-sm-6">
                                <a href="LoginCliente/LoginCliente.jsp">
                                    <div class="container">
                                        <img src="imagens/353938376.jpg" class="image" alt="Pessoa Física" width="100%" height="auto">
                                        <div class="middle">
                                            <div class="text">Cliente faça o seu Login.</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6">
                                <a href="LoginProfissional/LoginProfissional.jsp">
                                    <div class="container">
                                        <img src="imagens/447406066.jpg" class="image" alt="Pessoa Jurídica" width="100%" height="auto">
                                        <div class="middle">
                                            <div class="text">Profissional faça o seu Login.</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
