...
<html>
    <head>
        ...
        <title>ISERVICES - Orçamento Recusado</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        O Orcamento foi recusado com sucesso!
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="./index.jsp"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Orçamento Recusado</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <p>Confira em "Orçamentos Reprovados", os orçamentos que foram recusados</p>
                    <!--<h3 style="color: black">O Orcamento foi enviado com sucesso! <br/>Clique no botão abaixo para conferir os pedidos recusados!</h3>-->
                    <div class="row">
