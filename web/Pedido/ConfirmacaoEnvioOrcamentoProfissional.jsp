...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação Envio de Orçamento</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 style="color: black">O Orcamento foi enviado com sucesso! <br/>Clique no botão abaixo para conferir os orçamentos em espera!</h3>
                    <div class="row">
