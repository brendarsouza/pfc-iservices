...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação de Orçamento Aceito</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        O Orçamento foi aceito.
                    </h1>
                    <small>Confira em "Orçamentos Aprovados" o orçamento aceito.</small>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Confirmação de Orçamento</li>
                    </ol>
                </section>
                            ...
                            <div class="small-box bg-orange">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="../consultarOrcamentoCliente">Todos Orcamentos <span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a href="../consultarOrcamentosEmEsperaCliente">Orcamentos Em Espera<span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a href="../consultarOrcamentosAprovadosCliente">Orcamentos Aprovados<span class="pull-right badge bg-green"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a href="../consultarOrcamentosReprovadosCliente">Orcamentos Reprovados<span class="pull-right badge bg-red"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
