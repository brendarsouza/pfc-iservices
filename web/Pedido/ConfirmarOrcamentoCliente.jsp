...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmar Orçamento Cliente</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Aceitar Orçamento Recebido
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="./index.jsp"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Confirmação Orçamento</li>
                    </ol>
                </section>

                <section class="content">
                    <form action="./aceitarOrcamento" method="post">
                        <input type="name" hidden  name="txtIdUsuario" value=<%= usuario.getId()%>>
                        ...
                        <input type="name" hidden name="txtDataDesejada" value=<%= orcamento.getPedido().getDataDesejada()%>>
                        <input type="name" hidden name="txtDataPedido" value=<%= orcamento.getPedido().getDataPedido()%>>
                        <input type="name" hidden name="txtDescricaoProblema" value=<%= orcamento.getPedido().getDescricaoProblema()%>>
                        <input type="name" hidden name="txtHorarioFinalDisponivel" value=<%= orcamento.getPedido().getHorarioFinalDisponivel()%>>
                        <input type="name" hidden name="txtHorarioInicialDisponivel" value=<%= orcamento.getPedido().getHorarioInicialDisponivel()%>>
                        ...
                        <input type="name" hidden name="txtStatus" value=<%= orcamento.getPedido().getStatus_Pedido()%>>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <h5 class="widget-user-desc"><b>Descrição do Problema: </b><br/>"<i><%=orcamento.getPedido().getDescricaoProblema()%></i>"</h5>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Dia em que o cliente está disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data disponível: </b></a><%=orcamento.getPedido().getDataDesejada()%></h5>
                                        <h5 class="widget-user-desc"><a style="color: #000;" data-toggle="tooltip" title="Horário em que o cliente está disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Horário disponível: </b></a><%=orcamento.getPedido().getHorarioInicialDisponivel()%> até <%=orcamento.getPedido().getHorarioFinalDisponivel()%></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="box box-widget">
                                    ...
                                    <div class="box-footer">
                                        <h5 class="widget-user-desc" style="text-align: right;"><b>Data do Orçamento: </b><%=orcamento.getDataOrcamento()%></h5>
                            ...
                            <input  type="submit" class="btn btn-success center-block"  id="btnSalvar"  value="Aceitar">
                        </div>
                    </form>
                </section>
