...
<html>
    <head>
        ...
        <title>ISERVICES - Formulário Pedido Cliente</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Formulário de Pedido</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-header bg-aqua-active">
                                    <h4 style="text-align: right;">Dados do Profissional</h4>
                                    <h3 class="widget-user-username"><%=profissional.getNome()%> <%=profissional.getSobrenome()%></h3>

                                </div>

                                <div class="box-footer">
                                    <h5 class="widget-user-desc"><%=profissional.getProfissao().getProfissaoNome()%></h5>
                                    <h5 class="widget-user-desc"><%=profissional.getEndereco().getBairro()%>, <%=profissional.getEndereco().getCidade()%> - <%=profissional.getEndereco().getEstado()%></h5>
                                    <h5 class="widget-user-desc">Atendimento: <%= profissional.getHorarioDeAtendimentoInicio()%> às <%= profissional.getHorarioDeAtendimentoFim()%></h5>
                                    
                                    <br/>

                                    <!--<h4><b>Dias e horários indisponíveis:</b></h4>-->
                                    
                                    <center>
                                        <h4>Média de Avaliação</h4>
                                        <h5 class="widget-user-desc"><i class="fa fa-star text-yellow"></i> <%=profissional.getMediaAvaliacaoGeral()%>  <i class="fa fa-usd text-green"></i> <%=profissional.getMediaAvaliacaoCusto()%>  <i class="fa fa-clock-o text-aqua"></i> <%=profissional.getMediaAvaliacaoRapidez()%> </h5>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Preencher solicitação</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                        ...
                                        <div class="box-body">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="5" name="txtDescricaoProblema" id="descricaoProblema" required></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label><a style="color: #000;" data-toggle="tooltip" title="Dia em que você estará disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i>Data desejada:</a></label>

                                                            <div class="input-group date">
                                                                <div class="input-group-addon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </div>
                                                                <input type="date" class="form-control pull-right" name="txtDataDesejada" id="datepicker" required>
                                                            </div>
                                                        </div>


                                                        <div class="col-sm-6">
                                                            <label><a style="color: #000;" data-toggle="tooltip" title="Horário em que você estará disponível para receber o serviço!"><i class="fa fa-info-circle fa-fw w3-margin-right w3-large w3-text-teal"></i>Horário disponível:</a></label>
                                                            <!--<label>Date:</label>-->
                                                            <div class="row">
                                                                <div class="col-sm-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="time" class="ss-q-time form-control pull-left required" dir="auto" id="horarioDeAtendimento" required=""  name="txtHorarioInicialDisponivel"> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    <h5>até</h5>
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="time" class="ss-q-time form-control pull-left required" dir="auto" id="txtHorarioDeAtendimentoFim" required=""  name="txtHorarioFinalDisponivel"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <!-- InputMask -->
        <script src="admtle/jquery.inputmask.js"></script>
        <script src="admtle/jquery.inputmask.date.extensions.js"></script>
        <script src="admtle/jquery.inputmask.extensions.js"></script>
