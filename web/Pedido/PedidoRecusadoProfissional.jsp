...
<html>
    <head>
        ...
        <title>ISERVICES - Pedido Recusado</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Pedido Recussado</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <p>Confira em "Pedidos Reprovados" os pedidos que foram recusados</p>
                        ...
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <p>Confira os pedidos recusados</p>
                                </div>
                                <div class="icon">
