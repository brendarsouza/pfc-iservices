...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmar Recusa Pedido</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    <form action="./recusarPedido" method="post" > 
                        <div class="container">
                            <br>
                            <!-- id do u-->
                            ...
                            <input type="text" hidden name="txtIdProfissional" value="<%=pedido.getProfissional().getId()%>">
                            ...
                            <input type="text" hidden name="txtPrazo" value="<%=pedido.getHorarioFinalDisponivel()%>">        

                            <input type="text" hidden name="txtDataPedido" value="<%=pedido.getDataPedido()%>">

                            <h1 style="text-align: center;">
                                Você deseja Recusar o Pedido?
                            </h1>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-widget">
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= pedido.getCliente().getEndereco().getCidade()%> - <%= pedido.getCliente().getEndereco().getEstado()%></small></p> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input  type="submit" class="btn btn-success center-block"  id="btnRecusar"  value="Recusar">                        
                                </div>
                                <div class="col-sm-5">
                                </div>
                            </div>
