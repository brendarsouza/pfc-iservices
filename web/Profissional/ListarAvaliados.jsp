...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Pedidos Avaliados</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Listar Pedidos Avaliados
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Lista de Pedidos Avaliados</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-green">
                            <h3 class="box-title" style="color: white;">Pedidos Avaliados</h3>
