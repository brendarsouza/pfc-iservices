                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-success" style="width: 100%" type="button">
                                                        <a href="./aceitarAgendamentoProfissional?idAceitarAgendamentoProfissional=<%= agenda.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i>Aceitar Agendamento</a>
                                                    </button>
