...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação de Edição Profissional</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            Profissional profissional = (Profissional) request.getAttribute("profissionalEditado");
            Profissional profissionalEditado = (Profissional) session.getAttribute("profissional");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <h3 class="profile-username text-center"><%=profissional.getNome()%> <%=profissional.getSobrenome()%></h3>

                                    <p class="text-muted text-center"><%=profissional.getUsuario().getEmail()%></p>
                                    <p><br/></p>
                                    <p class="text-muted text-center">
                                    <div class="row">
                                        <div class="col-sm-6 text-center">
                                            <b>CPF: </b> <a class="text-muted"><%=profissional.getCpf()%></a>
                                        </div>
                                        <div class="col-sm-6 text-center">
                                            <b>RG:</b> <a class="text-muted"><%=profissional.getRg()%></a>
                                        </div>
                                    </div>
                                    </p>
                                </div>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <p><br/></p>
                                    <p class="text-muted"><i class="fa fa-birthday-cake text-fuchsia" aria-hidden="true"></i> <%= profissional.getDataNascimento()%></p>
                                    <p class="text-muted"><i class="fa fa-mobile text-black" aria-hidden="true"></i> <%= profissional.getCelular()%></p>
                                    <p class="text-muted"><i class="fa fa-phone text-aqua" aria-hidden="true"></i> <%= profissional.getTelefone()%></p>
                                    <hr>

                                    <strong><i class="fa fa-map-marker margin-r-5 text-blue"></i> Endereço</strong>
                                    <p><br/></p>
                                    <p class="text-muted"><%= profissional.getEndereco().getRua()%>, <%= profissional.getEndereco().getNumero()%></p>
                                    <p class="text-muted">CEP: <%= profissional.getEndereco().getCep()%></p>
                                    <p class="text-muted"><%= profissional.getEndereco().getBairro()%>, <%= profissional.getEndereco().getCidade()%> - <%= profissional.getEndereco().getEstado()%></p>

                                    <hr>



                                    <strong><i class="fa fa-pencil margin-r-5"></i> Dados Profissionais</strong>

                                    <p>
                                        <span class="label label-success"><i class="fa fa-briefcase" aria-hidden="true"></i> <%= profissional.getProfissao().getProfissaoNome()%> </span>
                                        <span class="label label-success"><%= profissional.getProfissao().getCategoria().getCategoriaNome()%> </span>
                                        <% if((profissional.getFormacao() != null) ||(profissional.getFormacao() != null)){ %>
                                        <span class="label label-primary"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <%= profissional.getFormacao()%></span>
                                        <span class="label label-primary"><%= profissional.getInstituicao()%></span>

                                        <%
                                            }
%>
                                        <span class="label label-info"><i class="fa fa-clock-o"></i><%= profissional.getHorarioDeAtendimentoInicio()%></span>
                                        <span class="label label-info"><i class="fa fa-clock-o"></i><%= profissional.getHorarioDeAtendimentoFim()%></span>

                                    </p>

                                    <hr>

                                    <strong><i class="fa fa-file-text-o margin-r-5"></i> Descrição Serviços</strong>

                                    <p><%= profissional.getDescricaoServicos()%></p>
                                </div>
