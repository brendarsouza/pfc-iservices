...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Agendamentos Cancelada Profissional</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Agendamentos Cancelados</li>
                    </ol>
                </section>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><i class="fa fa-clock-o" aria-hidden="true"></i><b> Data do Cancelamento: </b> <%=agenda.getDataFinalizacao() %></p>
