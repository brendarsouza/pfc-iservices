...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmar Inativação de Conta Profissional</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('../imagens/447406066.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                ...
                <section class="content">
                    <form action="../ControleAcessoProfissional" method="post">
                       <div class="container">
                        ...
                        <small>Confirme seus dados para desativar sua conta.</small></center>
				...
				<input type="email" id="inputEmail" class="form-control" name="txtEmail" placeholder="Email" required autofocus>
                                ...
                                <br/>
                                <input type="submit" class="btn btn-lg btn-primary btn-block btn-signin" value="Inativar" name="acao"/>                               
