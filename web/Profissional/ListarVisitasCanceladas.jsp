...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Visitas Canceladas Profissional</title>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= visita.getPedido().getCliente().getEndereco().getRua()%>, <%= visita.getPedido().getCliente().getEndereco().getNumero()%> - <%= visita.getPedido().getCliente().getEndereco().getBairro()%> - <%= visita.getPedido().getCliente().getEndereco().getCidade()%></small></p> 
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <p style="text-align: right"> <i class="fa fa-calendar-times-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b style="color: #dd2c00;">Data do Cancelamento: </b><%=visita.getDataOperacao()%></p>
                                                <p style="text-align: right"> <i class="fa fa-commenting-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b style="color: #dd2c00;">Observação: </b><%=visita.getObservacao()%> </p>
                                            </div>
                                            <div class="col-md-2">
