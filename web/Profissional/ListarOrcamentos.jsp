...
<html>
    <head>
        ...
        <title>ISERVICES - Todos Orçamentos Profissional</title>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%=orcamento.getPedido().getCliente().getNome()%> <%=orcamento.getPedido().getCliente().getSobrenome()%> </h2></p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= orcamento.getPedido().getCliente().getEndereco().getCidade()%> - <%= orcamento.getPedido().getCliente().getEndereco().getEstado()%></small></p> 
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h4><i class="fa fa-user-o" aria-hidden="true"></i> | <%=orcamento.getPedido().getCliente().getNome()%></span></h4>
                                                    <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= orcamento.getPedido().getCliente().getEndereco().getCidade()%> - <%= orcamento.getPedido().getCliente().getEndereco().getEstado()%></small></p> 
