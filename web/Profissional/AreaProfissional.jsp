...
<html>
    <head>
        ...
        <title>ISERVICES - Área do Profissional</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Área do Profissional</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-purple">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="./buscarTodasAvaliacoesProfissional">Todas Avaliações<span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a href="./buscarAvaliacoesPendentesProfissional">Avaliações Pendentes <span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
