                ...
                <section class="content">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-warning btn-lg" style="width: 100%" type="button">
                                                        <a href="./cancelarVisitaProfissional?idCancelarVisitaProfissional=<%=visita.getId()%>" style="color: white"><i class="fa fa-remove img-circle text-default"></i> Cancelar Visita</a>
                                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <button type="button" class="btn btn-warning" ><a href="./cancelarVisitaProfissional?idCancelarVisitaProfissional=<%=visita.getId()%>" style="color: white"><i class="fa fa-times-circle-o img-circle text-default"></i> Cancelar Visita</a></button>
                                                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitas) {
                                    if(visita.getStatus_Visita() == Status_Visita.APROVADA ){
                            %> 
                            <input type="text" hidden name="txtIdVisita" value="<%=visita.getId()%>">
                            <input type="text" hidden name="txtIdPedido" value="<%=visita.getPedido().getId()%>">
                            <div class="panel-body">
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=visita.getPedido().getId()%></div>
                                                <p style="text-align: right"><span class="label label-success"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Aprovada </span></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn btn-primary btn-md" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=visita.getPedido().getId()%>">
                                                        <a href="#" style="color: white"><i class="fa fa-plus-circle img-circle text-default"></i> Ver mais</a>
                                                    </button>
                                                    ...
                                                    <button class="btn btn-success btn-md" style="width: 100%" type="button">
                                                        <a href="./enviarOrcamento?idPedido=<%= visita.getPedido().getId()%>" style="color: white"><i class="fa fa-paper-plane-o img-circle text-default"></i> Fazer Orçamento</a>
                                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button type="button" class="btn btn-warning pull-left" ><a href="./cancelarVisitaProfissional?idCancelarVisitaProfissional=<%=visita.getId()%>" style="color: white"><i class="fa fa-times-circle-o img-circle text-default"></i> Cancelar Visita</a></button>
                                                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitas) {
                                    if(visita.getStatus_Visita() == Status_Visita.CANCELADA){
                            %> 
                            <input type="text" hidden name="txtIdVisita" value="<%=visita.getId()%>">
                            <input type="text" hidden name="txtIdPedido" value="<%=visita.getPedido().getId()%>">
                            <div class="panel-body">
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=visita.getPedido().getId()%></div>
                                                <p style="text-align: right"><span class="label label-info"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Cancelada </span></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
