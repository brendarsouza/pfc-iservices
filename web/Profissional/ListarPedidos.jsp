...
<html>
    <head>
        ...
        <title>ISERVICES - Todos Pedidos Profissional</title>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%=pedido.getCliente().getNome()%> <%=pedido.getCliente().getSobrenome()%> </h2></p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= pedido.getCliente().getEndereco().getRua()%>, <%= pedido.getCliente().getEndereco().getNumero()%> -<%= pedido.getCliente().getEndereco().getCidade()%> - <%= pedido.getCliente().getEndereco().getEstado()%></small></p> 
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn  btn-primary btn-md " style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=pedido.getId()%>">
                                                        <a href="#" style="color: white"><i class="fa fa-plus-circle img-circle text-default"></i> Ver mais</a>
                                                    </button>
                                                    <button class="btn btn-warning btn-md" style="width: 100%" type="button">
                                                        <a href="./recusarPedido?idRecusarPedido=<%= pedido.getId()%>" style="color: white"><i class="fa fa-remove img-circle text-default"></i> Recusar Pedido</a>
                                                    </button>
                                                    <button class="btn btn-success btn-md" style="width: 100%" type="button">
                                                        <a href="./enviarOrcamento?idPedido=<%= pedido.getId()%>" style="color: white"><i class="fa fa-paper-plane-o img-circle text-default"></i> Fazer Orçamento</a>
                                                    </button>
                                                    <button class="btn btn-primary btn-md" style="width: 100%" type="button">
                                                        <a href="./agendarVisita?idAgendarPedido=<%= pedido.getId()%>" style="color: white"><i class="fa fa-calendar-check-o img-circle text-default"></i> Agendar Visita</a>
                                                    </button>
                                                </span>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row ">
                                                        <center>
                                                        <div class="col-md-3">
                                                            <button type="button" class="btn btn-default pull-center" data-dismiss="modal">Fechar</button>
                                                        </div>
                                                        <div class="col-md-3 ">
                                                        ...
                                                        <div class="col-md-3">
                                                            <button class="btn btn-primary pull-center"  type="button">
                                                                <a href="./agendarVisita?idAgendarPedido=<%= pedido.getId()%>" style="color: white"><i class="fa fa-calendar-check-o img-circle text-default"></i> Agendar Visita</a>
                                                            </button>
                                                        </div>
                                                        </center>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=pedido.getId()%></div>
                                                <p style="text-align: right"><span class="label label-success"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> <% if (pedido.getStatus_Pedido() == Status_Pedido.APROVADO) {%> Aprovado <% }%></span></p>
                                                <p style="text-align: right" class="text-muted"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=pedido.getDataPedido()%></p>
