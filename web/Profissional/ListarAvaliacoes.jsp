...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Avaliações</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Listar Avaliações</li>
                    </ol>
                </section>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= avaliacao.getAgenda().getOrcamento().getPedido().getCliente().getEndereco().getCidade()%> - <%= avaliacao.getAgenda().getOrcamento().getPedido().getCliente().getEndereco().getEstado()%></small></p> 
