...
<html>
    <head>
        ...
        <title>ISERVICES - Listar Agendamentos Profissional</title>
                ...
                <section class="content container-fluid">
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #ffb300; ">
                            <h3 class="box-title" style="color: white;">Todos Agendamentos Em Espera</h3>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i>Data do serviço: <%=agenda.getDataAgendamento()%> às <%=agenda.getHoraAgendamento()%> </p>                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>&emsp;"<%= agenda.getOrcamento().getDescricaoSolucao()%>"</i> </p> 
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-warning" style="width: 100%" type="button">
                                                        <a href="./cancelarAgendamentoProfissional?idCancelarAgendamentoProfissional=<%= agenda.getId()%>" style="color: white"><i class="fa fa-times img-circle text-default"></i>Cancelar Visita</a>
                                                    </button>
                                                    <button class="btn btn-success" style="width: 100%" type="button">
                                                        <a href="./finalizarPedido?idFinalizar=<%= agenda.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i>Finalizar Serviço</a>
                                                    </button>
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-aqua ">
                            <h3 class="box-title" style="color: white;">Todos Agendamentos Cancelados</h3>
                        ...
                        <div class="box-body">
                            <% for (AgendaDeServico agenda : agendas) {
                                    ...
                                    if (agenda.getStatus_servico() == Status_Servico.CANCELADO) {
                            %> 
                            <div class="panel-body">
                                <div class="row-fluid">
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%=agenda.getOrcamento().getPedido().getCliente().getNome()%> <%=agenda.getOrcamento().getPedido().getCliente().getSobrenome()%> </h2></p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= agenda.getOrcamento().getPedido().getCliente().getEndereco().getCidade()%> - <%= agenda.getOrcamento().getPedido().getCliente().getEndereco().getEstado()%></small></p> 
                                                <p><i class="fa fa-clock-o" aria-hidden="true"></i><b> Data do Cancelamento: </b> [</p>
                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço </b><%=agenda.getOrcamento().getDataPrevistaInicio()%> às <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=agenda.getOrcamento().getHoraVisita()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>&emsp;"<%= agenda.getOrcamento().getDescricaoSolucao()%>"</i> </p> 
                                                <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Prazo para conclusão do Serviço: </b><%=agenda.getOrcamento().getPrazo()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data gastos: </b><%=agenda.getOrcamento().getGastos()%></p>
                    ...
                    <!--PEDIDOS REAGENDADOS-->
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #f012be ; ">
                            <h3 class="box-title" style="color: white;">Pedidos Reagendados</h3>
                        ...
                        <div class="box-body">
                            <% for (AgendaDeServico agenda : agendas) {
                                    if (agenda.getStatus_servico() == Status_Servico.REAGENDADO) {
                            %> 
                            <div class="panel-body">
                                <div class="row-fluid">
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%= agenda.getOrcamento().getPedido().getCliente().getNome()%> <%= agenda.getOrcamento().getPedido().getCliente().getSobrenome()%> </h2></p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço </b><%= agenda.getOrcamento().getPedido().getCliente().getEndereco().getCidade()%> - <%= agenda.getOrcamento().getPedido().getCliente().getEndereco().getCidade()%></small></p> 
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <% } else if (agenda.getStatus_servico() == Status_Servico.CANCELADO) {%>
                                                <p style="text-align: right"><span class="label label-aqua"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Cancelado </span></p>
                                                <% } else if (agenda.getStatus_servico() == Status_Servico.REAGENDADO) {%>
                                                <p style="text-align: right"><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Reagendado </span></p>
                                                <% }%>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn btn-primary btn-md" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=agenda.getOrcamento().getId()%>">
                                                        <a href="#" style="color: white"><i class="fa fa-plus-circle img-circle text-default"></i> Ver mais</a>
                                                    </button>
                                                    <button class="btn btn-warning" style="width: 100%" type="button">
                                                        <a href="./recusarAgendamentoProfissional?idRecusarAgendamentoProfissional=<%= agenda.getId()%>" style="color: white"><i class="fa fa-times img-circle text-default"></i>Recusar Agendamento</a>
                                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p> <h4>Pedido </h4> </p>
                                                    <p style="text-align: right" class="text-muted"><i class="fa fa-clock-o" aria-hidden="true"></i> <b>Data do Pedido:</b> <%=agenda.getOrcamento().getPedido().getDataPedido()%></p>
                                                    <% if (agenda.getOrcamento().getPedido().getStatus_Pedido() == Status_Pedido.REPROVADO) {%>
                                                    <p><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Em Espera </span></p>
                                                    <% } else if (agenda.getOrcamento().getPedido().getStatus_Pedido() == Status_Pedido.APROVADO) {%>
                                                    <p><span class="label label-success"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Aprovado </span></p>
                                                    <% } else if (agenda.getOrcamento().getPedido().getStatus_Pedido() == Status_Pedido.REPROVADO) {%>
