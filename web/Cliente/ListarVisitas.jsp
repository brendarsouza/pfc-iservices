...
<html>
    <head>
        ...
        <title>ISERVICES - Todas Visitas Cliente</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            List<Visita> visitasRemarcadas = (List<Visita>) request.getAttribute("visitaRemarcada");
            List<Visita> visitasAprovadas = (List<Visita>) request.getAttribute("visitaAprovada");
            List<Visita> visitasEm_Espera = (List<Visita>) request.getAttribute("visitaEm_Espera");
            List<Visita> visitasReprovadas = (List<Visita>) request.getAttribute("visitaReprovada");
            List<Visita> visitasCanceladas = (List<Visita>) request.getAttribute("visitaCancelada");
        %>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #ffb300; ">
                            <h3 class="box-title" style="color: white;">Todas Visitas Em Espera</h3>
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitasEm_Espera) {
                                    if(visita.getStatus_Visita() == Status_Visita.EM_ESPERA ){
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <p style="text-align: right"><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> <% if (visita.getStatus_Visita() == Status_Visita.EM_ESPERA){%> Em Espera <% } %></span></p>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-warning btn-lg" style="width: 100%" type="button">
                                                        <a href="./cancelarVisita?idCancelarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-remove img-circle text-default"></i> Cancelar Visita</a>
                                                    </button>
                                                    <button class="btn btn-success btn-lg" style="width: 100%" type="button">
                                                        <a href="./aceitarVisita?idAceitarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-heart-o img-circle text-default"></i> Aceitar Visita</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <button type="button" class="btn btn-warning pull-left" ><a href="./cancelarVisita?idCancelarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-times-circle-o img-circle text-default"></i> Cancelar Visita</a></button>
                                                        </div>
                                                        <div class="col-md-4">
                                                        <button type="button" class="btn btn-success pull-left">
                                                        <a href="./aceitarVisita?idAceitarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-heart-o img-circle text-default"></i> Aceitar Visita</a></button>
                                                        </div>
                                                        <div class="col-md-4">
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-green">
                            <h3 class="box-title" style="color: white;">Todas Visitas Aprovados</h3>
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitasAprovadas) {
                            %> 
                            <input type="text" hidden name="txtIdVisita" value="<%=visita.getId()%>">
                            <input type="text" hidden name="txtIdPedido" value="<%=visita.getPedido().getId()%>">
                            <div class="panel-body">
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=visita.getPedido().getId()%></div>
                                                <p style="text-align: right"><span class="label label-success"><i class="fa fa-check-circle-o text-default" aria-hidden="true"></i> <% if (visita.getStatus_Visita() == Status_Visita.APROVADA){%> Aprovada <% } %></span></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
                    ...
                    <div class="box">
                        ...
                        <!-- Default box -->
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #00bcd4; ">
                            <h3 class="box-title" style="color: white;">Todas Visitas Canceladas</h3>
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitasCanceladas) {
                            %> 
                            <input type="text" hidden name="txtIdVisita" value="<%=visita.getId()%>">
                            <input type="text" hidden name="txtIdPedido" value="<%=visita.getPedido().getId()%>">
                            <div class="panel-body">
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=visita.getPedido().getId()%></div>
                                                <p style="text-align: right"><span class="label label-info"><i class="fa fa-times-circle-o text-default" aria-hidden="true"></i> <% if (visita.getStatus_Visita() == Status_Visita.CANCELADA){%> Canceladas <% } %></span></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><hr/></p>
                                                    <p> <h4>Pedido </h4> </p>
                                                    <p style="text-align: right"><span class="label label-info"><i class="fa fa-times-circle-o text-default" aria-hidden="true"></i> <% if (visita.getStatus_Visita() == Status_Visita.CANCELADA){%> Cancelada <% } %></span></p>
                        ...
                        <!--VISITAS REMARCADAS-->
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #db0ead; ">
                            <h3 class="box-title" style="color: white;">Todas Visitas Remarcadas</h3>
                        ...
                        <div class="box-body">
                            <% 
                                for (Visita visita : visitasRemarcadas) {
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%=visita.getPedido().getProfissional().getNome()%> <%=visita.getPedido().getProfissional().getSobrenome()%> </h2></p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço Atendimento: </b><%= visita.getPedido().getProfissional().getCidadeAtendimento()%> - <%= visita.getPedido().getProfissional().getEstadoAtendimento()%></small></p> 
                                                <p><hr/></p>
                                                <p><h4><b>Visita Remarcada</b> </h4> </p>
                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data desejada do serviço: </b><%=visita.getPedido().getDataDesejada()%> <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=visita.getPedido().getHorarioInicialDisponivel()%> até <%=visita.getPedido().getHorarioFinalDisponivel()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição do Problema:</b> <br/> <i>"<%= visita.getPedido().getDescricaoProblema()%>"</i> </p> 
                                                <p><i class="fa fa-commenting-o" aria-hidden="true"></i> <b style="color: #dd2c00;">Observação:</b> <br><i>"<%=visita.getObservacao()%>"</i></p>

                                                <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b style="color: #dd2c00;">Nova Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
                                            </div>
                                            <div class="col-md-5">

                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=visita.getPedido().getId()%></div>
                                                <p style="text-align: right"><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"><% if(visita.getStatus_Visita() == Status_Visita.REMARCADA){ %> Remarcada <%}%></i> </span></p>
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Pedido: </b><%=visita.getPedido().getDataPedido()%></p>
                                                <p style="text-align: right"><i class="fa fa-clock-o" aria-hidden="true"></i> <b>Data de modificação: </b> <%=visita.getDataOperacao()%></p>
                                    ...
                                    <div id="myModal<%=visita.getPedido().getId()%>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p><h4><%=visita.getPedido().getProfissional().getNome()%> <%=visita.getPedido().getProfissional().getSobrenome()%> </h4></p>
                                                    <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço Atendimento: </b><%= visita.getPedido().getProfissional().getCidadeAtendimento()%> - <%= visita.getPedido().getProfissional().getEstadoAtendimento()%></small></p>  
                                                    <p><hr/></p>
                                                    <p> <h4>Pedido </h4> </p>
                                                    <p style="text-align: right"><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"><% if(visita.getStatus_Visita() == Status_Visita.REMARCADA){ %> Remarcada <%}%></i> </span></p>
                                                    ...
                                                    <p><i class="fa fa-file-text-o" aria-hidden="true"></i><b> Descrição Problema:</b><br/> <i>"<%=visita.getPedido().getDescricaoProblema()%>"</i></p>
                                                    <p><hr/></p>
                                                    <p><h4>Visita Remarcada </h4> </p>
                                                    <p><i class="fa fa-commenting-o" aria-hidden="true"></i> <b>Observação:</b> <br><i>"<%=visita.getObservacao()%>"</i></p>
                                                    <p><i class="fa fa-clock-o" aria-hidden="true"></i> <b>Horário em que a visita foi remarcada</b> <%=visita.getDataOperacao()%></p>
                                                    <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b style="color: #dd2c00;">Nova Data da Visita: </b><%=visita.getDataVisita()%> às <%=visita.getHoraVisita()%></p>
                                                </div>
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <button type="button" class="btn btn-warning" ><a href="./cancelarVisita?idCancelarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-times-circle-o img-circle text-default"></i> Cancelar Visita</a></button>
                                                        </div>
