...
<html>
    <head>
        ...
        <title>ISERVICES - Todos Orçamentos Cliente</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            List<Orcamento> orcamentos = (List<Orcamento>) request.getAttribute("orcamento");
        %>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #ffb300; ">
                            <h3 class="box-title" style="color: white;">Todos Orçamentos Em Espera</h3>
                        ...
                        <div class="box-body">
                            <% for (Orcamento orcamento : orcamentos) {
                                if (orcamento.getStatus_Orcamento() == Status_Orcamento.EM_ESPERA) {
                            %> 
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><h2><%=orcamento.getPedido().getProfissional().getNome()%> <%=orcamento.getPedido().getProfissional().getSobrenome()%> </h2></p>
                                                <p><small><strong><%=orcamento.getPedido().getProfissional().getProfissao().getProfissaoNome()%> - <%=orcamento.getPedido().getProfissional().getProfissao().getCategoria().getCategoriaNome()%></strong></small> </p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço de Atendimento: </b><%= orcamento.getPedido().getProfissional().getCidadeAtendimento()%> - <%= orcamento.getPedido().getProfissional().getEstadoAtendimento()%></small></p> 

                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço </b><%=orcamento.getDataPrevistaInicio()%> às <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=orcamento.getHoraVisita()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>&emsp;"<%= orcamento.getDescricaoSolucao()%>"</i> </p> 
                                                <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Prazo para conclusão do Serviço: </b><%=orcamento.getPrazo()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data gastos: </b><%=orcamento.getGastos()%></p>
                                                <p><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Preço Final: </b><%=orcamento.getPrecoFinal()%></p>

                                            </div>
                                            <div class="col-md-5">

                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=orcamento.getPedido().getId()%></div>
                                                <% if (orcamento.getStatus_Orcamento() == Status_Orcamento.EM_ESPERA){%>
                                                ...
                                                <% } else if (orcamento.getStatus_Orcamento() == Status_Orcamento.APROVADO){%>
                                                <p style="text-align: right"><span class="label label-success"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Aprovado </span></p>
                                                <% } else if (orcamento.getStatus_Orcamento() == Status_Orcamento.REPROVADO){%>
                                                <p style="text-align: right"><span class="label label-danger"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Reprovado </span></p>
                                                <% } %>

                                                <p style="text-align: right" class="text-muted"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Orçamento </b><%=orcamento.getDataOrcamento()%></p>
                                            ...
                                            <div class="col-md-2">
                                               ...
                                               <span class="pull-right">
                                                    <button class="btn btn-primary" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=orcamento.getId()%>">
                                                    ...
                                                    <button class="btn btn-warning" style="width: 100%" type="button">
                                                        <a href="./recusarOrcamento?idRecusarOrcamento=<%=orcamento.getId()%>" style="color: white"><i class="fa fa-remove img-circle text-default"></i> Recusar Orçamento</a>
                                                    </button>
                                                    <button class="btn btn-success" style="width: 100%" type="button">
                                                        <a href="./aceitarOrcamento?idAceitarOrcamento=<%=orcamento.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i> Aceitar Orçamento</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
                            ...
                            <div class="row slideanim">
                                <div class="col-sm-12">
                                    <!-- Modal -->
                                    <div id="myModal<%=orcamento.getId()%>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h4><i class="fa fa-user-o" aria-hidden="true"></i> | <%=orcamento.getPedido().getProfissional().getNome()%></span></h4>
                                                    <p><small><strong><%=orcamento.getPedido().getProfissional().getProfissao().getProfissaoNome()%> - <%=orcamento.getPedido().getProfissional().getProfissao().getCategoria().getCategoriaNome()%></strong></small> </p>
                                                    <p><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Região de Atendimento: </b><%= orcamento.getPedido().getProfissional().getCidadeAtendimento()%> - <%= orcamento.getPedido().getProfissional().getEstadoAtendimento()%></p> 
                                                    <p><hr/></p>
                                                    <p> <h4>Pedido </h4> </p>
                                                    <p style="text-align: right" class="text-muted"><i class="fa fa-clock-o" aria-hidden="true"></i> <b>Data do Pedido:</b> <%=orcamento.getPedido().getDataPedido()%></p>
                                                    <% if (orcamento.getPedido().getStatus_Pedido() == Status_Pedido.EM_ESPERA){%>
                                                    <p><span class="label label-warning"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Em Espera </span></p>
                                                    <% } else if (orcamento.getPedido().getStatus_Pedido() == Status_Pedido.APROVADO){%>
                                                    <p><span class="label label-success"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Aprovado </span></p>
                                                    <% } else if (orcamento.getPedido().getStatus_Pedido() == Status_Pedido.REPROVADO){%>
                                                    <p><span class="label label-danger"><i class="fa fa-clock-o text-default" aria-hidden="true"></i> Reprovado </span></p>
                                                    <% } %>


                                                    <p><b> Nº Pedido: </b><%=orcamento.getPedido().getId()%></p>

                                                    <p><i class="fa fa-calendar-check-o" aria-hidden="true"></i> <b>Dia disponível para receber o serviço: </b><%=orcamento.getPedido().getDataDesejada()%></p>
                                                    <p><i class="fa fa-clock-o" aria-hidden="true"></i><b> Horário disponível para receber o serviço:</b> <%=orcamento.getPedido().getHorarioInicialDisponivel()%> às <%=orcamento.getPedido().getHorarioFinalDisponivel()%> </p>
                                                    <p><i class="fa fa-file-text-o" aria-hidden="true"></i><b> Descrição Problema:</b><br/> <i>"<%=orcamento.getPedido().getDescricaoProblema()%>"</i></p>
                                                    <p><hr/></p>
                                                    ...
                                                    <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço: </b><%=orcamento.getDataPrevistaInicio()%> às <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=orcamento.getHoraVisita()%></p>
                                                    <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>"<%= orcamento.getDescricaoSolucao()%>"</i> </p> 
                                                    <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Prazo para conclusão do Serviço: </b><%=orcamento.getPrazo()%></p>
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button type="button" class="btn btn-warning" ><a href="./recusarOrcamento?idRecusarOrcamento=<%=orcamento.getId()%>" style="color: white"><i class="fa fa-times-circle-o img-circle text-default"></i> Recusar Orçamento</a></button>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <button class="btn btn-success" type="button"><a href="./aceitarOrcamento?idAceitarOrcamento=<%=orcamento.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i> Aceitar Orçamento</a></button>
                                                        </div>  
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-green ">
                            <h3 class="box-title" style="color: white;">Todos Orçamentos Aprovados</h3>
                        ...
                        <div class="box-body">
                            <% for (Orcamento orcamento : orcamentos) {
                                if (orcamento.getStatus_Orcamento() == Status_Orcamento.APROVADO) {
                            %> 
                            <div class="panel-body">
                                <div class="row-fluid">
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço </b><%=orcamento.getDataPrevistaInicio()%> às <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=orcamento.getHoraVisita()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>"<%= orcamento.getDescricaoSolucao()%>"</i> </p> 
                                                <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço: </b><%=orcamento.getPrazo()%></p>
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data gastos: </b><%=orcamento.getGastos()%></p>
                                                <p><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Preço Final: </b><%=orcamento.getPrecoFinal()%></p>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn  btn-primary btn-lg" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=orcamento.getId()%>">
                                                        <a href="#" style="color: white"><i class="fa fa-plus-circle img-circle text-default"></i> Ver mais</a>
                                                    </button>
                                                </span>
                                            </div>
                        ...
                        <div class="box-header with-border bg-red ">
                            <h3 class="box-title" style="color: white;">Todos Orçamentos Reprovados</h3>
                        ...
                        <div class="box-body">
                            <% for (Orcamento orcamento : orcamentos) {
                                if (orcamento.getStatus_Orcamento() == Status_Orcamento.REPROVADO) {
                            %> 
                            <div class="panel-body">
                                <div class="row-fluid">
                                    <div class="span3">
