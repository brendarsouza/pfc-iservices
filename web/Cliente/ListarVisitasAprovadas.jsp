...
<html>
    <head>
        ...
        <title>ISERVICES - Todas Visitas Aprovadas Cliente</title>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <p style="text-align: right"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b style="color: #dd2c00;">Data da Aprovação </b><%=visita.getDataOperacao()%></p>
                                            </div>
                                            <div class="col-md-2">
