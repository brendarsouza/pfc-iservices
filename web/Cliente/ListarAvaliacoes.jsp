...
<html>
    <head>
        ...
        <title>ISERVICES - Todas Avaliações Cliente</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Todas Avaliações Cliente</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #ffb300; ">
                            <h3 class="box-title" style="color: white;">Avaliações Pendentes</h3>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <p><small><strong><%=avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getProfissao().getProfissaoNome()%> - <%=avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getProfissao().getCategoria().getCategoriaNome()%></strong></small> </p>
                                                <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço de Atendimento: </b><%= avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getCidadeAtendimento()%> - <%= avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getEstadoAtendimento()%></small></p> 
                                                <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i>Data do serviço: <%=avaliacao.getAgenda().getDataAgendamento()%> às <%=avaliacao.getAgenda().getHoraAgendamento()%> </p>                                                
                                                <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>&emsp;"<%= avaliacao.getAgenda().getOrcamento().getDescricaoSolucao()%>"</i> </p> 
                                                <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Prazo para conclusão do Serviço: </b><%=avaliacao.getAgenda().getOrcamento().getPrazo()%></p>
                                                ...
                                                <p><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Preço Final: </b><%=avaliacao.getAgenda().getOrcamento().getPrecoFinal()%></p>


                                            </div>
                                            <div class="col-md-5">

                                                <div style="text-align: right" class="text-muted"><b> Nº Pedido: </b><%=avaliacao.getAgenda().getOrcamento().getPedido().getId()%></div>
                                                <% if (avaliacao.getStatus() == Status_Avaliacao.PENDENTE){%>
                                                ...
                                                <p style="text-align: right" class="text-muted"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Finalização do Servico: </b><%=avaliacao.getAgenda().getDataFinalizacao()%></p>
                                                <p></p>
                                                <p style="text-align: right"><i class="fa fa-commenting-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Comentario: </b> 
                                                ...
                                                <%}%>
                                                <p style="text-align: right"><i class="fa fa-star fa-fw w3-margin-right w3-large w3-text-teal text-yellow"></i><b>Avaliação Geral: </b> <%=avaliacao.getAvaliacaoGeral()%></p>
                                                <p style="text-align: right"><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal text-green"></i><b>Avaliação de Custo: </b> <%=avaliacao.getAvaliacaoCusto()%></p>
                                                <p style="text-align: right"><i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal text-aqua"></i><b>Avaliação de Rapidez: </b> <%=avaliacao.getAvaliacaoRapidez()%></p>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn btn-primary btn-lg" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=avaliacao.getAgenda().getOrcamento().getId()%>">
                                                        ...
                                                        <button class="btn btn-default btn-lg" style="width: 100%; background-color: white;" type="button">
                                                        <a href="./avaliarServico?idAvaliacao=<%= avaliacao.getAgenda().getId()%>" ><i class="fa fa-star fa-lg" style="color: yellow; border-color: #ffc107;"></i> Avaliar</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <p><small><strong><%=avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getProfissao().getProfissaoNome()%> - <%=avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getProfissao().getCategoria().getCategoriaNome()%></strong></small> </p>
                                                  <p><hr/></p>
                                                    ...
                                                    <p><b> Nº Pedido: </b><%=avaliacao.getAgenda().getOrcamento().getPedido().getId()%></p>

                                                    <p><i class="fa fa-calendar-check-o" aria-hidden="true"></i> <b>Dia disponível para receber o serviço: </b><%=avaliacao.getAgenda().getOrcamento().getPedido().getDataDesejada()%></p>
                                                    <p><i class="fa fa-clock-o" aria-hidden="true"></i><b> Horário disponível para receber o serviço:</b> <%=avaliacao.getAgenda().getOrcamento().getPedido().getHorarioInicialDisponivel()%> às <%=avaliacao.getAgenda().getOrcamento().getPedido().getHorarioFinalDisponivel()%> </p>
                                                    <p><i class="fa fa-file-text-o" aria-hidden="true"></i><b> Descrição Problema:</b><br/> <i>"<%=avaliacao.getAgenda().getOrcamento().getPedido().getDescricaoProblema()%>"</i></p>
                                                    <p><hr/></p>

                                                    <p> <h4>Orcamento </h4> </p>
                                                    <p style="text-align: right" class="text-muted"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data do Orçamento: </b><%=avaliacao.getAgenda().getOrcamento().getDataOrcamento()%></p>
                                                    ...
                                                    <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data início do Serviço: </b><%=avaliacao.getAgenda().getDataAgendamento()%> às <i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <%=avaliacao.getAgenda().getHoraAgendamento()%></p>
                                                    <p><i class="fa fa-file-text-o fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Descrição da Solução:</b> <br/> <i>"<%= avaliacao.getAgenda().getOrcamento().getDescricaoSolucao()%>"</i> </p> 
                                                    <p><i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Prazo para conclusão do Serviço: </b><%=avaliacao.getAgenda().getOrcamento().getPrazo()%></p>
                                                    ...
                                                    <p style="text-align: right" class="text-muted"> <i class="fa fa-calendar-check-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Data da Finalização: </b><%=avaliacao.getAgenda().getDataFinalizacao()%></p>
                                                    ...
                                                    <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i>Data do serviço: <%=avaliacao.getAgenda().getDataAgendamento()%> às <%=avaliacao.getAgenda().getHoraAgendamento()%> </p>
                                                    <hr/>
                                                    <p><i class="fa fa-commenting-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Comentario: </b> 
                                                        <%if (avaliacao.getComentario() == null) {
                                                        %>
                                                ...
                                                <%}%>
                                                    <p><i class="fa fa-star fa-fw w3-margin-right w3-large w3-text-teal text-yellow"></i><b>Avaliação Geral: </b> <%=avaliacao.getAvaliacaoGeral()%></p>
                                                    <p><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal text-green"></i><b>Avaliação de Custo: </b> <%=avaliacao.getAvaliacaoCusto()%></p>
                                                    <p><i class="fa fa-clock-o fa-fw w3-margin-right w3-large w3-text-teal text-aqua"></i><b>Avaliação de Rapidez: </b> <%=avaliacao.getAvaliacaoRapidez()%></p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Fechar</button>
                                                    <button class="btn btn-default btn-lg pull-left" style="background-color: white;" type="button">
                                                        <a href="./avaliarServico?idAvaliacao=<%= avaliacao.getAgenda().getId()%>" ><i class="fa fa-star fa-lg" style="color: yellow; border-color: #ffc107;"></i> Avaliar</a>
                                                    </button>
                                                </div>
                                            </div>
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-green">
                            <h3 class="box-title" style="color: white;">Avaliações Avaliados</h3>
                                    ...
                                    <div id="myModal<%=avaliacao.getAgenda().getOrcamento().getId()%>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h2><i class="fa fa-user-o" aria-hidden="true"></i> | <%=avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getNome()%></span></h2>
                                                    <p><small><i class="fa fa-map-marker fa-fw w3-margin-right w3-large w3-text-teal"></i> <b>Endereço: </b><%= avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getCidadeAtendimento()%> - <%= avaliacao.getAgenda().getOrcamento().getPedido().getProfissional().getEstadoAtendimento()%></small></p> 
