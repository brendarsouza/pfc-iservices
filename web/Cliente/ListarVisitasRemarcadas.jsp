                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-success btn-lg" style="width: 100%" type="button">
                                                        <a href="./aceitarVisita?idAceitarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i> Aceitar Visita</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button class="btn btn-success" type="button"><a href="./aceitarVisita?idAceitarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i> Aceitar Visita</a></button>
                                                        </div>  
                                                    </div>
                                                </div>
                                            </div>
