...
<html>
    <head>
        ...
        <title>ISERVICES - Todos Agendamentos Cliente</title>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border" style="background-color: #ffb300; ">
                            <h3 class="box-title" style="color: white;">Agendamentos Em Espera</h3>
                        ...
                        <div class="box-body">
                            <% for (AgendaDeServico agenda : agendas) {
                                    if (agenda.getStatus_servico() == Status_Servico.EM_ESPERA && agenda.getOrcamento().getStatus_Orcamento() == Status_Orcamento.APROVADO) {
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    <button class="btn btn-primary btn-lg" style="width: 100%" type="button" data-toggle="modal" data-target="#myModal<%=agenda.getOrcamento().getId()%>">
                                                        ...
                                                        <a href="./cancelarAgendamento?idCancelarAgendamento=<%= agenda.getId()%>" style="color: white"><i class="fa fa-times img-circle text-default"></i>Cancelar Visita</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
                    ...
                    <div class="box">
                        <div class="box-header with-border bg-aqua ">
                            <h3 class="box-title" style="color: white;">Agendamentos Cancelados</h3>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <% for (AgendaDeServico agenda : agendas) {
                                    if (agenda.getStatus_servico() == Status_Servico.EM_ESPERA && agenda.getOrcamento().getStatus_Orcamento() == Status_Orcamento.EM_ESPERA) {
                            %> 
                            <div class="panel-body">
                                <div class="row-fluid">
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-warning" style="width: 100%" type="button">
                                                        <a href="./recusarAgendamento?idRecusarAgendamento=<%= agenda.getId()%>" style="color: white"><i class="fa fa-times img-circle text-default"></i>Recusar Agendamento</a>
                                                    </button>
                                                    <button class="btn btn-success" style="width: 100%" type="button">
                                                        <a href="./aceitarAgendamento?idAceitarAgendamento=<%= agenda.getId()%>" style="color: white"><i class="fa fa-check img-circle text-default"></i>Aceitar Agendamento</a>
                                                    </button>
