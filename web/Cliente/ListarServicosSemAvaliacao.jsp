...
<html>
    <head>
        ...
        <title>ISERVICES - Pedidos Não Avaliados</title>
                                    ...
                                    <div class="span3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <p></p>
                                                <p style="text-align: right"><i class="fa fa-commenting-o fa-fw w3-margin-right w3-large w3-text-teal"></i><b>Comentário: </b> 
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-default btn-lg" style="width: 100%; background-color: white;" type="button">
                                                        <a href="./avaliarServico?idAvaliacao=<%= avaliacao.getId()%>" ><i class="fa fa-star fa-lg" style="color: yellow; border-color: #ffc107;"></i> Avaliar</a>
                                                    </button>
                                                </span>
                                            </div>
                                        </div>
