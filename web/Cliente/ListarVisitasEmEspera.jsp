...
<html>
    <head>
        ...
        <title>ISERVICES - Todas Visitas Em Espera Cliente</title>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <% 
                                ...
                                if(visita.getStatus_Visita() == Status_Visita.EM_ESPERA && visita.getPedido().getStatus_Pedido() != Status_Pedido.EM_ESPERA ){
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <span class="pull-right">
                                                    ...
                                                    <button class="btn btn-warning btn-lg" style="width: 100%" type="button">
                                                        <a href="./cancelarVisita?idCancelarVisita=<%=visita.getId()%>" style="color: white"><i class="fa fa-remove-circle img-circle text-default"></i> Cancelar Visita</a>
                                                    </button>
