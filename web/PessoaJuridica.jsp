...
<html>
    <head>
        ...
        <title>ISERVICES - Pessoa Juridica</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Cadastro Pessoa Jurídica</li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <center>
                            <div class="col-sm-6">
                                <a href="Cadastro/NovoClientePJur.jsp">
                                    <div class="container">
                                        <img src="imagens/Cliente.jpg" class="image" alt="Cliente" width="100%">
                                        <div class="middle">
                                            <div class="text">Sou Cliente</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6">
                                <a href="Cadastro/NovoProfissionalPJur.jsp">
                                    <div class="container">
                                        <img src="imagens/PrestadorDeServicos.jpg" class="image" alt="Prestador de Serviços" width="100%">
                                        <div class="middle">
                                            <div class="text">Sou Prestador de Serviços</div>
                                        </div>
                                    </div>
                                </a>
                            </div>
